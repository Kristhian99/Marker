...
public class marketController {
    ...
    @PutMapping("/admin")
    public Fruit transfer(@RequestParam(value = "kind")Kind kind,
    ...
    public Fruit updateMarekt(@RequestBody Fruit fruit,@RequestParam(value = "kind") Kind kind){
        return fruitService.updateMarekt(fruit,kind);
    }
